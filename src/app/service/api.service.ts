...
export class ApiService {
  ...
  getProfile(member_id: string): Observable<any> {
    ...
    return this.http.get(this.baseURL + '/Destiny2/2/Profile/' + member_id + '/', {params: params})
  }
  ...
  getCharacter(member_id: string, character_id: string) {
    return this.http.get(this.baseURL + '/Destiny2/2/Profile/' + member_id + '/Character/' + character_id + '/')
  }

  // 1851423
  getClanReword(clan_id: string) {
    return this.http.get(this.baseURL + '/Destiny2/Clan/' + clan_id + '/WeeklyRewardState/')
  }
